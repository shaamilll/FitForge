        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <p
              ...
              style={{ color: "#d4d4d8" }}
            >
              Premium performance apparel engineered for movement. Built for
              those who train with purpose.
            </p>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-500 bg-gray-900/70 text-white shadow-sm transition-all duration-300 hover:border-orange-500 hover:bg-white/10 hover:scale-105"
                  >
