...
const IconButton = ({ icon, label, onClick, badgeCount }) => {
  return (
    <button
      ...
      onClick={onClick}
      aria-label={label}
      className="relative flex h-10 w-10 items-center justify-center rounded-full text-gray-800 transition-all duration-300 hover:bg-gray-100 hover:text-orange-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
    >
